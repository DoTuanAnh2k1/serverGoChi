...
func configLoadValues() {
	...
	// Server Port Value
	Config.SetDefault("SERVER_PORT", "9233")
	...
	Config.SetDefault("MYSQL_USER", "user")
	Config.SetDefault("MYSQL_PASSWORD", "password")
	Config.SetDefault("MYSQL_DB_NAME", "")
	Config.SetDefault("MYSQL_HOST", "localhost")
	Config.SetDefault("MYSQL_PORT", "3306")
	config_models.DatabaseConfigInit = config_models.Config{
		Db: config_models.DatabaseConfig{
			DbType: Config.GetString("DB_DRIVER"),
			Mysql: config_models.MySqlConfig{
				...
				Name:     Config.GetString("MYSQL_DB_NAME"),
			},
		},
	}
}
