// Package postgres implements DatabaseStore on GORM + PostgreSQL. The
// implementation is character-for-character identical to the MySQL driver
// (pkg/repository/mysql/repo.go) except for this package declaration —
// GORM abstracts the dialect, and nothing here needs postgres-specific SQL.
package postgres
